...
function calcularTabla() {
    ...
    if (inputTabla > 0) {
        ...
        do {
            ...
            tabla += `<div class="col-md-1 colum-green"><h3>${contador}</h3></div>`;
            tabla += `<div class="col-md-1 colum"><h3>x</h3></div>`;
            tabla += `<div class="col-md-1 colum-green"><h3>${inputTabla}</h3></div>`;
            tabla += `<div class="col-md-1 colum"><h3>=</h3></div>`;
            tabla += `<div class="col-md-1 colum-green"><h3>${resultado}</h3></div>`;
            tabla += `</div>`;
