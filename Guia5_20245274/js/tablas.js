// Creacion de tablas usando concatenacion de cadenas
let table = "<table>";
table += "<thead>";
table += "<tr>";
...
const alumnos = [
    ...
    {id: 3, nombre:"Alexis Armando", apellido:"Quintanilla Pena", correo:
    "alexis.quintanilla@estudiante.esen.edu.sv" },
    {id: 4, nombre:"Vanessa Alejandra", apellido:"Bermudez Urquilla", correo:
    "vanessa.bermudez@estudiante.esen.edu.sv" },
